...
document.write('<tr style="background:#98C416;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#DDFF76" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function cs_over(e) {
	evtTgt(EvtObj(e)).style.background='#ECFFB5';
}
function cs_out(e) {
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #DDFF76';//'1px solid #606060';
	...
	for(var d=1;d<=42;d++) {
		...
		if ((d >= (cd -(-1)))&&(d<=cd-(-marr[cm]))) {
			...
			if (sccm == cm && sccd == (d-cd) && sccy == cy)
				cv.style.color='#98C416';

			// if selected date
			if (cm == selectedm && cy == selectedy && selectedd == (d-cd) )
			{
				cv.style.background='#ECFFB5';
